...
*/
const int MSGVER = 208; // KGJV updated for R5 - 203 Imago R5Contrib 7/11/09 (missionparam.bAllowAllied*) - 204 Imago FAZR6 (wing behavior), + #2 6/10
						// 206 Imago, #62 (remote version) 7/10
						// 207 roid info (#100)  //208 #132 more He3 updates
