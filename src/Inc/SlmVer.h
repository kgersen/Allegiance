...
#define rel     1040047.00       // mmf added to designate release number for a given build

#define rup		211220  // mmf make sure this has 6 digits otherwise version number conversion for esc display may fail,
