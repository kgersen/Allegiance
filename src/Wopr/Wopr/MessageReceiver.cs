...
namespace Wopr
{
    ...
    public class MessageReceiver : MarshalByRefObject
    {
        ...
        */
        ...
        public delegate void FMD_S_CLUSTERINFO_Event(AllegianceInterop.ClientConnection client, AllegianceInterop.FMD_S_CLUSTERINFO message);
        public event FMD_S_CLUSTERINFO_Event FMD_S_CLUSTERINFO;
