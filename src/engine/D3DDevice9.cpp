...
void CD3DDevice9::InitialiseSamplerStateCache( DWORD dwSamplerIndex, DWORD * pSamplerStateCache )
{
	...
	RESET_SAMPLER_STATE_CACHE_VALUE( dwSamplerIndex, D3DSAMP_ADDRESSU, D3DTADDRESS_CLAMP );
	RESET_SAMPLER_STATE_CACHE_VALUE( dwSamplerIndex, D3DSAMP_ADDRESSV, D3DTADDRESS_CLAMP );
	RESET_SAMPLER_STATE_CACHE_VALUE( dwSamplerIndex, D3DSAMP_ADDRESSW, D3DTADDRESS_CLAMP );
