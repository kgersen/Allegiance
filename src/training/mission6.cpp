...
namespace Training
{
    ...
    //------------------------------------------------------------------------------
    bool       Mission6::HandlePickDefaultOrder(IshipIGC* pShip)
    {
        debugf("Mission6::HandlePickDefaultOrder for %s\n", pShip->GetName());
    ...
    Condition*  Mission6::CreateMission (void)
    {
        ...
        {
            Goal*	pGoal = new Goal(new ElapsedTimeCondition(0.4f));
