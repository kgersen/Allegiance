  ...
  m_dwMaxShipsUpdateLatencyThreshold(0)
{
  ...
  for (i = 0; i < sizeofArray(m_rShipAngleThresholds); ++i)
    m_rShipAngleThresholds[i] = 0.f;
  for (i = 0; i < sizeofArray(m_rShipDistanceThresholds); ++i)
    m_rShipDistanceThresholds[i] = 0.f;
  for (i = 0; i < sizeofArray(m_dwShipsUpdateLatencyThresholds); ++i)
